...
def testar_ia():
    ...
    try:
        resposta = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "Você é um agente inteligente do projeto EcoGuardians."},
...
# 🔁 Seus outros endpoints continuam abaixo normalmente...
# (exemplo: /api/agents, /api/system/status, etc.)
# Eles podem ser colados aqui sem alteração.